...
public class FlightServiceImpl implements FlightService {
    ...
    public List<Ticket> getTicketList() {
        ...
        if( ticketList.size() == 0 ) {
            //偷懒不写数据库。。。
            addTicket(1, 8, "SH", "GY", 800, 50, "2020-06-13 ");
            addTicket(9, 16, "BJ", "SH", 600, 40, "2020-06-14 ");
            addTicket(17, 24, "HZ", "SH", 400, 50, "2020-06-17 ");
        }
    ...
    private void addTicket(int fi , int en , String departure , String destination , double price , int num , String day ){
        ...
        for( int i = fi ; i <= en ; i++ ){
            ...
            arrdate += ":00" ;
            Ticket ticket = new Ticket(tid,price,date,arrdate,num,departure,destination,"FLIGHT-A") ;
